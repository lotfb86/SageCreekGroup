...
import CommercialMortgageRatesChart from "./CommercialMortgageRatesChart";

export const metadata: Metadata = {
  title: "37 Years of Commercial Mortgage Rates — Sage Creek Group",
  description:
    "Permanent financing rates for stabilized investor real estate, 10-year fixed rate, quarterly from 1989 to Q1 2026.",
  robots: { index: false, follow: false },
};

export default function CommercialMortgageRatesPage() {
  return (
    <>
